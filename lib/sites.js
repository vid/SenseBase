...
var annoLoc = {
  ...
  'search\.clinicalevidence\.bmj\.com/s/search.html' : { resultLinks: ['#search-results'] }, // has no pager but an option for all results
  ...
  'ncbi\.nlm\.nih\.gov/pubmed/\\?term=' : { resultLinks: ['rslt'] }, // pager controlled by javascript
