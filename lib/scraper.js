...
function queueLink(uri, relevance, tags, referers, scraper, validated) {
  indexer.retrieveByURI(uri, function(err, result) {
    if (!result) {
      var queuedDetails = { tags: tags, relevance: relevance, lastAttempt: new Date().toISOString() }
