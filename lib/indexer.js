...
exports.saveSubscription = saveRecord('subscriptions', 'match');
exports.retrieveSubscriptions = retrieveRecords('subscriptions', ['member', 'match', 'created']);

exports.saveSearch = saveRecord('savedSearches', 'searchName');
...
exports.saveQuery = saveRecord('savedQueries', 'queryName');
exports.retrieveQueries = retrieveRecords('savedQueries', ['queryName']);
...
function saveRecord(rType, idField) {
