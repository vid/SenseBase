...
// retrieves a contentItem by uri
function retrieveByURI(uri, callback) {
  // FIXME shouldn't need double encoding?
  getEs().get({ _id: encodeURIComponent(encodeURIComponent(uri)), _type: 'contentItem'}, callback);
}
