    ...
    query(options, function(err, results) {
      ...
      if (results.hits) {
        ...
        if (options.navigation) {
           var nav = { navigation : options.navigation};
          // create annotation overview
          nav.clusters = results.clusters;
          nav.annotationOverview = formQuery.summarizeAnnotations(results);
          console.log('/query/navigation', nav.navigation, nav.annotationOverview.children.length, clientID);
        }
        // don't send annotations
        ...
        if (options.navigation) {
          publish('/query/navigation', nav, clientID);
        }
      } else {
