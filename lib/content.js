    ...
    if (result && result._source) {
      ...
      if (context.categories) {
        context.categories.forEach(function(category) {
          ...
          cItem.annotations.push(annotations.createAnnotation({hasTarget: desc.uri, type: 'category', category: category, state: utils.states.annotations.validated, annotatedBy: context.member}));
        });
      }
