...
// it has been indexed
    ...
    if (diffs.length > 0) {
      ...
      GLOBAL.debug('NOT UPDATED', diffs.length, diffs, 'lhs', hItem.annotations.length, cItem.annotations.length, JSON.stringify(hItem.annotations, null, 2), 'rhs', JSON.stringify(cItem.annotations, null, 2));
