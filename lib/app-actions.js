...
app.all('namespace + /__wm/*', function(req, res, next) {
    if (req.user) {
...
app.get(namespace + '/', function(req, res){
  if (req.user) {
    ...
    res.redirect(namespace + '__wm/index.html');
  } else {
...
app.get(namespace + '/logout', function(req, res){
  req.logout();
  res.redirect(namespace);
});

app.post(namespace + '/upload', function(req, res) {
