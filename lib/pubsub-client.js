...
exports.saveAnnotations = function(uris, annotations) {
  console.log('/saveAnnotations', uris, annotations.length);
...
exports.subRequestAnnotate = function(cb) {
  fayeClient.subscribe('/requestAnnotate', cb);
};
...
exports.itemIndexed = function(cItem, desc) {
  publish('/itemIndexed', {cItem: cItem, desc: desc});
};
