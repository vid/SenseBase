...
exports.loggedOut = function(cb) {
  fayeClient.subscribe('/loggedOut/' + clientID, cb);
};
...
exports.status = function(type, cb) {
  fayeClient.subscribe('/status/' + type + '/' + clientID, cb);
};
...
exports.item = {
  ...
  moreLikeThis : function(uri, options) {
    options.uri = uri;
    publish('/item/moreLikeThis', options);
  },
...
exports.watch = {
  ...
  delete : function(match) {
    console.log('/watch/delete', match);
    publish('/watch/delete', { match: match });
  },
