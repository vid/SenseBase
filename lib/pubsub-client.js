...
var clientID, username, homepage, fayeClient;

var faye = require('faye');

exports.init = function(context) {
  // running in a browser
  if (context.senseBase) {
    clientID = window.senseBase.username;
    ...
    fayeClient = new faye.Client(context.HOMEPAGE + 'faye/');
  } else {
    throw new Error('Unknown context');
  }

  console.log('faye init with', context);
  return this;
}
