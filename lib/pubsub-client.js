...
exports.item = {
  ...
  // Receive annotations for a content item.
    ...
    update : function(uri) {
      publish('/item/annotations/update', { uris: uri });
    },
  },
...
exports.subscriptions = {
  ...
  save : function(matches) {
    ...
    publish('/subscription/save', { matches: matches });
  },
